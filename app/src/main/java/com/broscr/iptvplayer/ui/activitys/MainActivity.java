        ...
        selectFileLauncher = registerForActivityResult(
                ...
                result -> {
                    if (result != null) {
                        ...
                        //Result uri file
                        if (Helper.checkFileType(result.toString())) {
                            //sending the uri of the m3u file to the reader
                            new FileReader(MainActivity.this, result.toString()).readFile();
                        } else {
                            Helper.showToast(MainActivity.this, getString(R.string.mime_error));
                        }
                    } else {
